        ...
        <GridBackground>
          ...
          >
            <h1 className="text-center max-w-4xl">
              <span className="block text-2xl md:text-3xl mb-4 text-primary-200">Rapidwork Solutions</span>
              Building Tomorrow's{' '}
              <span className="bg-gradient-to-r from-primary-200 to-secondary-500 bg-clip-text text-transparent">Digital Solutions</span>
            </h1>
          </MotionDiv>
